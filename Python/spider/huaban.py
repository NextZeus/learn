...
def replace_script_variable(script, userid):
    ...
    script = script.replace('var', '')\
        ...
        .replace('app={"page":{}}app.page = {}app.page["$url"] = "/boards/' + str(userid) + '/"app.page["board"] = ', '')
...
def download_huaban_image_by_userId(userid):
    ...
    url = "http://huaban.com/boards/"+str(userid)+"/"
    ...
    for script in soup.findAll('script'):
        ...
        if regex.findall(str(script)):
            app = replace_script_variable(script, userid)
            result = u'' + str(app)
            # print('result: ', result)
...
# http://huaban.com/boards/19232159/?max=877153997&limit=20&wfl=1
# http://huaban.com/boards/19232159/?max=668394537&limit=20&wfl=1
