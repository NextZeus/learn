...
# }
#
# print(min(zip(stocks.values(), stocks.keys()))) #(99.08, 'AAPL')
# print(max(zip(stocks.values(), stocks.keys()))) #(899.09, 'YHOO')
# print(sorted(zip(stocks.values(), stocks.keys()))) #[(99.08, 'AAPL'), (450.22, 'GOOG'), (899.09, 'YHOO')]
